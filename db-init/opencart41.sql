...
--
-- Хост: db
-- Час створення: Вер 02 2025 р., 11:54
...
--
-- Структура таблиці `oc_address_format`
--
...
--
-- Дамп даних таблиці `oc_address_format`
--
...
(1, 'Default', '', 1, '2025-09-02 11:52:29', '2025-09-02 11:52:29');

-- --------------------------------------------------------

--
-- Структура таблиці `oc_api_history`
--
...
--
-- Структура таблиці `oc_article_comment`
--
...
--
-- Структура таблиці `oc_article_rating`
--
...
--
-- Структура таблиці `oc_article_to_layout`
--
...
--
-- Структура таблиці `oc_country_description`
--
...
--
-- Дамп даних таблиці `oc_country_description`
--
...
--
-- Структура таблиці `oc_customer_affiliate_report`
--
...
--
-- Структура таблиці `oc_customer_authorize`
--
...
--
-- Структура таблиці `oc_customer_token`
--
...
--
-- Дамп даних таблиці `oc_custom_field`
--
...
--
-- Дамп даних таблиці `oc_custom_field_customer_group`
--
...
--
-- Дамп даних таблиці `oc_custom_field_description`
--
...
--
-- Дамп даних таблиці `oc_custom_field_value`
--
...
--
-- Дамп даних таблиці `oc_custom_field_value_description`
--
...
--
-- Структура таблиці `oc_download_report`
--
...
--
-- Дамп даних таблиці `oc_extension_path`
--
...
--
-- Структура таблиці `oc_identifier`
--
...
--
-- Дамп даних таблиці `oc_identifier`
--
...
--
-- Структура таблиці `oc_manufacturer_to_layout`
--
...
--
-- Структура таблиці `oc_marketing_report`
--
...
--
-- Структура таблиці `oc_notification`
--
...
--
-- Структура таблиці `oc_order_subscription`
--
...
--
-- Структура таблиці `oc_product_code`
--
...
--
-- Структура таблиці `oc_product_report`
--
...
--
-- Структура таблиці `oc_product_subscription`
--
...
--
-- Структура таблиці `oc_product_viewed`
--
...
('bc312c4dfd69d51a40bc363ee2', '{\"user_id\":\"1\",\"user_token\":\"340b917a8c52f166cc0db0437a156b0d\"}', '2025-09-03 11:53:02');
...
(101, 0, 'config', 'config_email', 'adminasd@sds.ss', 0),
...
--
-- Структура таблиці `oc_subscription`
--
...
--
-- Структура таблиці `oc_subscription_history`
--
...
--
-- Структура таблиці `oc_subscription_log`
--
...
--
-- Структура таблиці `oc_subscription_option`
--
...
--
-- Структура таблиці `oc_subscription_plan`
--
...
--
-- Дамп даних таблиці `oc_subscription_plan`
--
...
--
-- Структура таблиці `oc_subscription_plan_description`
--
...
--
-- Дамп даних таблиці `oc_subscription_plan_description`
--
...
--
-- Структура таблиці `oc_subscription_product`
--
...
--
-- Структура таблиці `oc_subscription_status`
--
...
--
-- Дамп даних таблиці `oc_subscription_status`
--
...
--
-- Структура таблиці `oc_topic_description`
--
...
--
-- Структура таблиці `oc_topic_to_layout`
--
...
--
-- Структура таблиці `oc_topic_to_store`
--
...
(1, 1, 'admin', '$2y$10$RUDfxHigzUa1031sEZ1ym.rNeEKNuRpMPo1TzwxWvSYup0krG1SAC', 'John', 'Doe', 'adminasd@sds.ss', '', '172.18.0.1', 1, '2025-09-02 11:52:29');

-- --------------------------------------------------------

--
-- Структура таблиці `oc_user_authorize`
--
...
--
-- Структура таблиці `oc_user_login`
--
...
--
-- Дамп даних таблиці `oc_user_login`
--

INSERT INTO `oc_user_login` (`user_login_id`, `user_id`, `ip`, `user_agent`, `date_added`) VALUES
(1, 1, '172.18.0.1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', '2025-09-02 11:53:01');

-- --------------------------------------------------------

--
-- Структура таблиці `oc_user_token`
--
...
--
-- Структура таблиці `oc_zone_description`
--
...
--
-- Дамп даних таблиці `oc_zone_description`
--
...
--
-- Індекси таблиці `oc_api_history`
--
...
--
-- Індекси таблиці `oc_article_comment`
--
...
--
-- Індекси таблиці `oc_article_rating`
--
...
--
-- Індекси таблиці `oc_article_to_layout`
--
ALTER TABLE `oc_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Індекси таблиці `oc_article_to_store`
--
...
--
-- Індекси таблиці `oc_country_description`
--
...
--
-- Індекси таблиці `oc_customer_affiliate_report`
--
...
--
-- Індекси таблиці `oc_customer_authorize`
--
...
--
-- Індекси таблиці `oc_customer_token`
--
...
--
-- Індекси таблиці `oc_download_report`
--
...
--
-- Індекси таблиці `oc_manufacturer_to_layout`
--
...
--
-- Індекси таблиці `oc_marketing_report`
--
...
--
-- Індекси таблиці `oc_notification`
--
...
--
-- Індекси таблиці `oc_order_subscription`
--
...
--
-- Індекси таблиці `oc_product_code`
--
...
--
-- Індекси таблиці `oc_product_report`
--
...
--
-- Індекси таблиці `oc_product_subscription`
--
...
--
-- Індекси таблиці `oc_product_viewed`
--
...
--
-- Індекси таблиці `oc_subscription`
--
...
--
-- Індекси таблиці `oc_subscription_status`
--
...
--
-- Індекси таблиці `oc_topic`
--
ALTER TABLE `oc_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Індекси таблиці `oc_topic_description`
--
...
--
-- Індекси таблиці `oc_topic_to_layout`
--
ALTER TABLE `oc_topic_to_layout`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Індекси таблиці `oc_topic_to_store`
--
...
--
-- Індекси таблиці `oc_user_authorize`
--
...
--
-- Індекси таблиці `oc_user_login`
--
ALTER TABLE `oc_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Індекси таблиці `oc_user_token`
--
...
--
-- Індекси таблиці `oc_zone_description`
--
...
--
-- AUTO_INCREMENT для таблиці `oc_address_format`
--
ALTER TABLE `oc_address_format`
  MODIFY `address_format_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблиці `oc_antispam`
--
ALTER TABLE `oc_antispam`
...
--
-- AUTO_INCREMENT для таблиці `oc_api_history`
--
ALTER TABLE `oc_api_history`
...
--
-- AUTO_INCREMENT для таблиці `oc_article_comment`
--
ALTER TABLE `oc_article_comment`
  MODIFY `article_comment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_article_rating`
--
ALTER TABLE `oc_article_rating`
...
--
-- AUTO_INCREMENT для таблиці `oc_cron`
--
ALTER TABLE `oc_cron`
...
--
-- AUTO_INCREMENT для таблиці `oc_customer_affiliate_report`
--
ALTER TABLE `oc_customer_affiliate_report`
...
--
-- AUTO_INCREMENT для таблиці `oc_customer_authorize`
--
ALTER TABLE `oc_customer_authorize`
...
--
-- AUTO_INCREMENT для таблиці `oc_customer_token`
--
ALTER TABLE `oc_customer_token`
...
--
-- AUTO_INCREMENT для таблиці `oc_download_report`
--
ALTER TABLE `oc_download_report`
...
--
-- AUTO_INCREMENT для таблиці `oc_gdpr`
--
ALTER TABLE `oc_gdpr`
...
--
-- AUTO_INCREMENT для таблиці `oc_identifier`
--
ALTER TABLE `oc_identifier`
...
--
-- AUTO_INCREMENT для таблиці `oc_marketing_report`
--
ALTER TABLE `oc_marketing_report`
...
--
-- AUTO_INCREMENT для таблиці `oc_notification`
--
ALTER TABLE `oc_notification`
...
--
-- AUTO_INCREMENT для таблиці `oc_order_subscription`
--
ALTER TABLE `oc_order_subscription`
...
--
-- AUTO_INCREMENT для таблиці `oc_product_code`
--
ALTER TABLE `oc_product_code`
...
--
-- AUTO_INCREMENT для таблиці `oc_product_report`
--
ALTER TABLE `oc_product_report`
...
--
-- AUTO_INCREMENT для таблиці `oc_startup`
--
ALTER TABLE `oc_startup`
...
--
-- AUTO_INCREMENT для таблиці `oc_subscription`
--
ALTER TABLE `oc_subscription`
  MODIFY `subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_history`
--
ALTER TABLE `oc_subscription_history`
  MODIFY `subscription_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_log`
--
ALTER TABLE `oc_subscription_log`
  MODIFY `subscription_log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_option`
--
ALTER TABLE `oc_subscription_option`
  MODIFY `subscription_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_plan`
--
ALTER TABLE `oc_subscription_plan`
  MODIFY `subscription_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_product`
--
ALTER TABLE `oc_subscription_product`
  MODIFY `subscription_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблиці `oc_subscription_status`
--
ALTER TABLE `oc_subscription_status`
...
--
-- AUTO_INCREMENT для таблиці `oc_topic`
--
ALTER TABLE `oc_topic`
...
--
-- AUTO_INCREMENT для таблиці `oc_user_authorize`
--
ALTER TABLE `oc_user_authorize`
...
--
-- AUTO_INCREMENT для таблиці `oc_user_login`
--
ALTER TABLE `oc_user_login`
  MODIFY `user_login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблиці `oc_user_token`
--
ALTER TABLE `oc_user_token`
